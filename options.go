...
// header.
//
// The middleware does a shallow req.Clone; it does NOT rewind request
// bodies. A retry layer above ghkit that re-sends a cloned request after
// its Body has been drained must supply req.GetBody, or construct a fresh
// *http.Request per retry.
